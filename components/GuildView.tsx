...
const ManageGuildView: React.FC = () => {
    ...
    const xpForNextLevel = GUILD_XP_TABLE[guild.level];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 space-y-6">
                <Card>
                    ...
                    <p className="text-xl font-semibold text-secondary mb-4">Guild Level {guild.level}</p>
                    <ProgressBar label="Guild XP" value={guild.xp} max={xpForNextLevel || guild.xp} colorClass="bg-purple-500" />
                </Card>
                <Card>
